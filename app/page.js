  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 overflow-x-hidden selection:bg-blue-500/10 selection:text-blue-600 relative">
      ...
      {/* ────────────────────────────────────────────────────────
         ...
         ──────────────────────────────────────────────────────── */}
      <section className="relative z-10 py-24 bg-transparent border-b border-slate-200/60">
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-center justify-between pt-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-bold text-slate-700">Scan or Transfer</span>
                  </div>
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-center justify-between pt-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-bold text-slate-700">Direct Route</span>
                  </div>
                ...
                <div className="space-y-1.5">
                  <h3 className="text-lg font-black text-slate-900">Direct Account-to-Account</h3>
                  <p className="text-xs text-slate-500 font-medium leading-relaxed">
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-center justify-between pt-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-bold text-slate-700">Instant Settle</span>
                  </div>
