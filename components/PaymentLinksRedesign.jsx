        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 pt-6">
            ...
            <div className="lg:col-span-5 flex flex-col">
              <div className="bg-gradient-to-b from-slate-900 to-slate-950 text-white p-5 rounded-2xl shadow-xl flex flex-col justify-between border border-slate-800 relative overflow-hidden h-full">
                ...
                <div className="relative z-10 flex flex-col gap-4">
                    ...
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        <div className="text-xs font-bold text-white flex items-center gap-1">
                          <span>{profile?.business_name || 'MyMobPay Tech'}</span>
                  ...
                  <div className="bg-slate-800/80 border border-slate-700/80 rounded-xl p-3.5 text-center">
                    ...
                    <div
                      id="preview-amount"
                      className="text-2xl font-black text-white tracking-tight mt-0.5 tabular-nums text-emerald-400"
                    >
                      {previewAmountFormatted}
                    </div>
                    <div className="mt-1 flex items-center justify-center gap-1.5 text-[11px] text-slate-300">
                      <span id="preview-purpose" className="font-medium truncate max-w-[200px]">
                        {previewPurposeFormatted}
                      </span>
                      <span>•</span>
                      <span id="preview-ref" className="font-mono text-slate-400 text-[10px]">
                        {previewRefFormatted}
                      </span>
                    </div>
                  </div>
                  ...
                  {/* QR Preview & Apps Row */}
                  <div className="bg-white p-3.5 rounded-xl flex flex-col items-center justify-center gap-2 shadow-inner">
                    <div className="p-1.5 bg-white rounded-lg border border-slate-100 shadow-xs">
                      <QRCode
                        value={activeUrl || 'https://mymob.tech/pay'}
                        size={110}
                  ...
                  <div className="flex flex-col gap-1.5">
                    <span className="text-[10px] uppercase tracking-wider text-slate-400 font-semibold">
                      Generated Dispatch URL:
                    </span>
                    <div className="bg-slate-800/90 border border-slate-700 rounded-lg p-2 flex items-center justify-between gap-2 text-xs">
                      <span
                        id="preview-url"
                        className="font-mono text-[11px] text-blue-300 truncate max-w-[220px]"
                        title={activeUrl}
                      >
                        {activeUrl}
                      </span>
                ...
                {/* Preview CTA actions */}
                <div className="relative z-10 pt-4 mt-2 border-t border-slate-800 grid grid-cols-2 gap-2">
                  <button
                    type="button"
                    onClick={() => {
                      copyText(activeUrl, 'Payment URL');
                    }}
                    className="inline-flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg bg-blue-600 hover:bg-blue-500 text-white font-semibold text-xs transition-colors"
                  >
                    <Copy className="w-3.5 h-3.5" />
                    Copy Link
                  </button>
                  ...
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white font-semibold text-xs transition-colors"
                  >
