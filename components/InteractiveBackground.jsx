...
export default function InteractiveBackground() {
  ...
  // Canvas Particles & Constellation System (Fully Mobile & Desktop Optimized)
  useEffect(() => {
    ...
    // Mobile: 24 particles, Desktop: 55 particles
  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden select-none" aria-hidden="true">
      ...
      <div
        className="absolute inset-0 opacity-[0.06] sm:opacity-[0.05] pointer-events-none"
        style={{
          backgroundImage: `
      ...
      {/* 3. Subtle Floating Geometric Outlines (Clean transparent border without dark/muddy fill) */}
      <div 
        className="absolute -top-20 sm:-top-28 -left-20 sm:-left-28 w-[340px] sm:w-[520px] h-[340px] sm:h-[520px] rounded-[50px] sm:rounded-[70px] border border-blue-400/20 bg-transparent rotate-12 animate-tech-float-1 pointer-events-none" 
      />

      <div 
        className="absolute top-[28%] -right-24 sm:-right-36 w-[360px] sm:w-[580px] h-[320px] sm:h-[480px] rounded-[60px] sm:rounded-[90px] border border-cyan-400/20 bg-transparent -rotate-6 animate-tech-float-2 pointer-events-none" 
      />

      <div 
        className="absolute -bottom-24 sm:-bottom-36 left-[10%] sm:left-[20%] w-[320px] sm:w-[540px] h-[300px] sm:h-[460px] rounded-[50px] sm:rounded-[80px] border border-indigo-400/15 bg-transparent rotate-45 animate-tech-float-3 pointer-events-none" 
      />
